...
def Apple(request):
    return render(request, 'wiki/Apple.html')
def Samsung(request):
    return render(request, 'wiki/Samsung.html')
def Sony(request):
    return render(request, 'wiki/Sony.html')
def HTC(request):
    return render(request, 'wiki/HTC.html')
def favorite(request):
    return render(request, 'wiki/favorite.html')
